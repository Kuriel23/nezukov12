...
module.exports.run = async (OldMessage, NewMessage, client) => {
  ...
  let MensagemEditadaEmbed = new Discord.MessageEmbed()
    .setAuthor("[MENSAGEM]", OldMessage.author.displayAvatarURL())
  ...
  client.channels.cache.get("960575934736502814").send(MensagemEditadaEmbed);
